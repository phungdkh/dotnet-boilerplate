...
using PhungDKH.Shared.Helpers;
using PhungDKH.Shared.Mvc.Filters;
using PhungDKH.Application.Common.Constants;
using PhungDKH.Application.Features.Account;
using PhungDKH.Application.Services.DataInitialize;
using Serilog;
using Swashbuckle.AspNetCore.SwaggerUI;
using FluentValidation;
using PhungDKH.Application.Services.Authentication;

namespace PhungDKH.Api.Extensions
{
    public static class WebApplicationBuilderExtensions
    {
        ...
        public static void ConfigureServices(this WebApplicationBuilder builder)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "PhungDKH",
                    Description = "PhungDKH API Docs",
                    TermsOfService = null,
                    Contact = new OpenApiContact { Name = "PHUNGDKH", Email = "phungdkh@gmail.com", Url = null },
                });
            ...
            services.AddPhungDKHAuthorization(configuration);
        ...
        public static void AppUseAndRun(this WebApplicationBuilder builder)
        {
            ...
            if ("local".Equals(AppConstants.APP_ENVIRONMENT))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "PhungDKH API");
                    c.DocumentTitle = "PhungDKH API";
