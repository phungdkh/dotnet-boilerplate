...
namespace SampleProject.Application.Features.Companies.Commands.Companies.Handler
{
    public class CompanyEditHandler : BaseHandler, IRequestHandler<CompanyEditRequest, ResponseModel>
    {
        ...
        /// </summary>
        /// <param name="fishwellGlobalDbContext">The Global Administrator database context.</param>
        /// <param name="contextAccessor"></param>
        public CompanyEditHandler(
            AppDbContext fishwellGlobalDbContext,
            IHttpContextAccessor contextAccessor) : base(contextAccessor)
        {
            _appDbContext = fishwellGlobalDbContext ?? throw new ArgumentNullException(nameof(fishwellGlobalDbContext));
        }
